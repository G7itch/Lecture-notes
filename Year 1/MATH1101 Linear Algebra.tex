...
Let \(V\) be a non-zero finite dimensional vector space. Suppose \(S=\{\arbvec{v}{s}\}\) such that \(\langle S\rangle=V\) then there is a subset \(B\subseteq S\) such that \(B\) is a basis of \(V\).
\end{document}
