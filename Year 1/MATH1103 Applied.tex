...
A fixed point of the map \(f\) is a point such that \(f(x^*)=x^*\) such that if \(x_n=x^*\) then \(x_{n+1}=x^*\). Fixed points are analogous to equilibrium points of differential equations. We can similarly look at the stability of fixed points of difference equations.
\end{document}
