...
If this is a separable ODE then we can solve it to find a conserved quantity: \(H(x,y)\). Note that all linearised conservative systems can have saddle points or linear centres but not attracting or repelling equilibrium points. While saddles remain saddles due to Hartman-Grobman, we need to be careful when looking at the behaviour of centres to make sure they remain how we think. 
\end{document}
